        ...
        <CardBody>
          <Form id="document-uplaod-form" action="" method="post" encType="multipart/form-data" className="form-horizontal">
            ...
            <FormGroup row>
              ...
              <Col xs="12" md="9">
                <Input type="text" id="exampleInputName2" maxLength="32" placeholder="Enter your name" name="name" onChange={(event) => props.handleChange(event)} required />
            ...
            <FormGroup row>
              ...
              <Col xs="12" md="9">
                <Input type="text" id="exampleInputName3" maxLength="32" placeholder="Photo, Pdf" name="docTags" onChange={(event) => props.handleChange(event)} required />
